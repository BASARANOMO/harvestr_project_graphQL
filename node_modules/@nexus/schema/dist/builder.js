...
class SchemaBuilder {
    ...
    checkForInterfaceCircularDependencies() {
        ...
        function walkType(obj, path, visited) {
    ...
    buildInterfaceType(config) {
        ...
        const interfaceTypeConfig = {
            ...
            resolveType,
            description,
            fields: () => this.buildOutputFields(fields, interfaceTypeConfig, this.buildInterfaceFields(interfaces)),
            extensions: {
    ...
    buildInterfaceFields(interfaces) {
