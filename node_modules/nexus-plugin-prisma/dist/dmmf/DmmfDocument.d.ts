...
export declare class DmmfDocument implements DmmfTypes.Document {
    ...
    enumsIndex: Index<DmmfTypes.SchemaEnum>;
    ...
    getInputTypeWithIndexedFields(inputTypeName: string): Pick<DmmfTypes.InputType, "name" | "constraints" | "computedInputs"> & {
    ...
    getEnumType(enumTypeName: string): DmmfTypes.SchemaEnum;
