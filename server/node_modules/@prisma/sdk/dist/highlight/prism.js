...
exports.Token = exports.Prism = void 0;
...
exports.Prism = {
    ...
    util: {
        ...
        clone: function deepClone(o, visited) {
            visited = visited || {};
            let clone, id;
            const type = exports.Prism.util.type(o);
            switch (type) {
                case 'Object':
    ...
    languages: {
        extend: function (id, redef) {
            const lang = exports.Prism.util.clone(exports.Prism.languages[id]);
        ...
        DFS: function DFS(o, callback, type, visited) {
            visited = visited || {};
            const objId = exports.Prism.util.objId;
            for (const i in o) {
                if (o.hasOwnProperty(i)) {
                    callback.call(o, i, o[i], type || i);
                    const property = o[i], propertyType = exports.Prism.util.type(property);
        ...
        for (const token in grammar) {
            ...
            for (let j = 0; j < patterns.length; ++j) {
                ...
                for (let i = index, pos = startPos; i < strarr.length; pos += strarr[i].length, ++i) {
                    ...
                    const wrapped = new Token(token, inside ? exports.Prism.tokenize(match, inside) : match, alias, match, greedy);
                    args.push(wrapped);
                    if (after) {
                        args.push(after);
                    }
    ...
    hooks: {
        ...
        add: function (name, callback) {
            const hooks = exports.Prism.hooks.all;
            hooks[name] = hooks[name] || [];
            hooks[name].push(callback);
        },
        run: function (name, env) {
            const callbacks = exports.Prism.hooks.all[name];
