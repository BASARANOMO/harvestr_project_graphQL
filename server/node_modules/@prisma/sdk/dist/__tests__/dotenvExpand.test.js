...
describe('dotenvExpand', () => {
    test('should not expand', () => {
        ...
        expect(dotenvExpand_1.dotenvExpand(config)).toMatchInlineSnapshot(`
      Object {
        "parsed": Object {
          "MYSQL1": "mysql://user:password@serv$er.host:5432/$database",
          "MYSQL2": "mysql://user:password@server.host:5432/d$atabase",
    ...
    it('returns object', () => {
        const dotenv = { parsed: {} };
        const obj = dotenvExpand_1.dotenvExpand(dotenv).parsed;
...
describe('integration', function () {
    ...
    beforeEach(() => {
        dotenv = require('dotenv').config({
            path: path_1.default.join(__dirname, './fixtures/dotenv/.env'),
        });
    });
    it('expands environment variables', () => {
        dotenvExpand_1.dotenvExpand(dotenv);
    ...
    it('multiple expand', () => {
        const obj = dotenvExpand_1.dotenvExpand(dotenv).parsed;
        expect(obj['WITHOUT_CURLY_BRACES_URI']).toBe('mongodb://$MONGOLAB_USER:$MONGOLAB_PASSWORD@$MONGOLAB_DOMAIN:$MONGOLAB_PORT/$MONGOLAB_DATABASE');
    });
    it('should expand recursively', () => {
        const obj = dotenvExpand_1.dotenvExpand(dotenv).parsed;
        expect(obj['WITHOUT_CURLY_BRACES_URI_RECURSIVELY']).toBe('mongodb://$MONGOLAB_USER_RECURSIVELY@$MONGOLAB_DOMAIN:$MONGOLAB_PORT/$MONGOLAB_DATABASE');
    });
...
//# sourceMappingURL=dotenvExpand.test.js.map