...
describe('signature', async () => {
  ...
  it('should return a consistent signature', async () => {
    ...
    assert__default['default'].equal(typeof signature, 'string');
    assert__default['default'].equal(signature.length, 36);
  });
  ...
  it('should get the signature from signature file', async () => {
    ...
    assert__default['default'].equal(typeof actualSignature, 'string');
    assert__default['default'].equal(actualSignature.length, 36);
    assert__default['default'].equal(expectedSignature, actualSignature);
  });
  ...
  it('should migrate the signature to the signature file from cache and return the migrated signature', async () => {
    ...
    assert__default['default'].equal(typeof actualSignature, 'string');
    assert__default['default'].equal(actualSignature.length, 36);
    assert__default['default'].equal(testCacheSignature, actualSignature);
  });
