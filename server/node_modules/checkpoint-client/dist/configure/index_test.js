...
describe('config', () => {
  ...
  describe('set, all, get, reset, delete data', () => {
    ...
    it('initial state', async () => {
      assert__default['default'].deepStrictEqual(await config.all(), undefined);
    });
    ...
    it('set one', async () => {
      ...
      assert__default['default'].deepStrictEqual(await config.all(), {
        last_reminder: 10,
        cached_at: 0,
        version: '',
        cli_path: '',
    ...
    it('get existing', async () => {
      ...
      assert__default['default'].equal(version, 10);
    });
