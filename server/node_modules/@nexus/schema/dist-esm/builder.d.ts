import { GraphQLField, GraphQLFieldConfig, GraphQLFieldConfigArgumentMap, GraphQLFieldConfigMap, GraphQLFieldResolver, GraphQLInputFieldConfig, GraphQLInputFieldConfigMap, GraphQLInputObjectType, GraphQLInputType, GraphQLInterfaceType, GraphQLNamedType, GraphQLNonNull, GraphQLObjectType, GraphQLOutputType, GraphQLSchema, GraphQLType, printSchema, GraphQLList } from 'graphql';
...
import { AllNexusNamedTypeDefs, NexusWrapKind, AllNexusNamedInputTypeDefs, AllNexusNamedOutputTypeDefs } from './definitions/wrapping';
import { MissingType, NexusFeaturesInput, NexusGraphQLInputObjectTypeConfig, NexusGraphQLInterfaceTypeConfig, NexusGraphQLObjectTypeConfig, NexusGraphQLSchema, NonNullConfig, RootTypings, TypingImport } from './definitions/_types';
...
export declare class SchemaBuilder {
    ...
    setConfigOption: <K extends "features" | "outputs" | "shouldGenerateArtifacts" | "typegenAutoConfig" | "typegenConfig" | "prettierConfig" | "formatTypegen" | "nonNullDefaults" | "plugins" | "customPrintSchemaFn">(key: K, value: BuilderConfigInput[K]) => void;
    hasConfigOption: (key: keyof BuilderConfigInput) => boolean;
    getConfigOption: <K extends "features" | "outputs" | "shouldGenerateArtifacts" | "typegenAutoConfig" | "typegenConfig" | "prettierConfig" | "formatTypegen" | "nonNullDefaults" | "plugins" | "customPrintSchemaFn">(key: K) => BuilderConfigInput[K];
